...
import io.conceptive.homestack.satellite.auth.internal.IAuthRestClient;
...
{
  @ConfigProperty(name = "homestack.satellite.oidc.client-id")
  String applicationID;

  @ConfigProperty(name = "homestack.user.mail")
  String userMail;

  @ConfigProperty(name = "homestack.user.apikey")
  String userAPIKey;
